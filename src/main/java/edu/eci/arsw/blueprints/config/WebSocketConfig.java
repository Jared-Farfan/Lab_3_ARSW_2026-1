...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    * - El endpoint es la URL a la que los clientes se conectarán para usar WebSocket.
    ...
    */
     ...
     * - enableSimpleBroker: Habilita un broker simple en memoria para manejar topics y queues.
     * - setApplicationDestinationPrefixes: Prefijo para destinos de aplicación (ej: /app/blueprints/create)
     * - setUserDestinationPrefix: Prefijo para destinos específicos de usuario (ej: /user/queue/notifications)
     */
    @Override
